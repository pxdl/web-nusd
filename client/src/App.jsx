...
const COLORS = {
  ...
  accent: '#7dcde8',
  accentDim: '#5cb8d4',
  accentGlow: 'rgba(125, 205, 232, 0.18)',
  warning: '#e8a317',
  error: '#d94040',
  success: '#5cb85c',
  text: '#474747',
...
const styles = {
  root: {
    fontFamily: '"Nunito", "Varela Round", -apple-system, "Segoe UI", sans-serif',
    color: COLORS.text,
    minHeight: '100vh',
    display: 'flex',
  ...
  toggleBtn: {
    background: 'linear-gradient(to bottom, #f0f1f3, #e4e6e8)',
    color: COLORS.textDim,
  ...
  toggleActive: {
    background: 'linear-gradient(to bottom, #e0f4fa, #c8eaf5)',
    color: COLORS.text,
    borderColor: COLORS.accent,
    boxShadow: '0 0 12px rgba(125, 205, 232, 0.3)',
  },
  // Checkboxes
  checkboxGroup: {
    display: 'flex',
  ...
  btnPrimary: {
    ...
    marginTop: 8,
    overflow: 'hidden',
    boxShadow: '0 2px 8px rgba(125, 205, 232, 0.2)',
  },
  btnSecondary: {
    background: 'linear-gradient(to bottom, #f0f1f3, #e4e6e8)',
    color: COLORS.text,
  ...
  btnSmall: {
    background: 'linear-gradient(to bottom, #f0f1f3, #e8eaec)',
    color: COLORS.textDim,
    border: `2px solid ${COLORS.border}`,
    borderRadius: '2rem',
    padding: '5px 14px',
  ...
  infoCard: {
    ...
    borderRadius: 20,
    padding: 16,
    boxShadow: '3px 3px 14px rgba(0, 0, 0, 0.07)',
  },
  infoTitle: {
    margin: '0 0 10px 0',
    fontSize: 14,
  ...
  modal: {
    ...
    flexDirection: 'column',
    overflow: 'hidden',
    boxShadow: '4px 6px 30px rgba(0, 0, 0, 0.15)',
  },
  modalHeader: {
    display: 'flex',
    justifyContent: 'space-between',
    ...
    background: 'linear-gradient(to bottom, #e8eaec, #d2d6db)',
  },
  modalTitle: {
    margin: 0,
    fontSize: 18,
  ...
  versionChipActive: {
    ...
    color: COLORS.text,
    borderColor: COLORS.accent,
    boxShadow: '0 0 8px rgba(125, 205, 232, 0.3)',
  },
  // Tree view
  treeCategory: {
    display: 'flex',
    ...
    fontSize: 14,
    color: COLORS.text,
    background: 'linear-gradient(to bottom, #e8eaec, #dcdfe2)',
    position: 'sticky',
    top: 0,
    zIndex: 1,
  },
